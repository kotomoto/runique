package com.koto.core.data.run

import com.koto.core.data.networking.get
import com.koto.core.database.dao.RunPendingSyncDao
import com.koto.core.database.mappers.toRun
import com.koto.core.domain.SessionStorage
import com.koto.core.domain.run.LocalRunDataSource
...
class OfflineFirstRunRepository(
    ...
    override suspend fun deleteRun(id: RunId) {
        ...
        // Edge case where the run is created in offline mode, ant then deleted in offline mode as well
        // In that case, we don't need to sync it
